...
protocol CorporateAboutDelegate {
    func CreateRequest(Cell:CorporateAboutCell)
}

class CorporateAboutCell: UICollectionViewCell {
    
    var Delegate:CorporateAboutDelegate?
    ...
    Delegate?.CreateRequest(Cell: self)
    }
    ...
    override init(frame: CGRect) {
        ...
        CreateRequest.topAnchor.constraint(equalTo: DetailsLabel.bottomAnchor,constant: ControlX(10)).isActive = true
        CreateRequest.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: ControlX(10)).isActive = true
        CreateRequest.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: ControlX(-10)).isActive = true
        CreateRequest.heightAnchor.constraint(equalToConstant: ControlWidth(50)).isActive = true
    }
