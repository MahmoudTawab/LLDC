...
protocol RestaurantAboutDelegate {
    func BookTicket(Cell:RestaurantAboutCell)
}

class RestaurantAboutCell: UICollectionViewCell {
    
    var Delegate:RestaurantAboutDelegate?
    ...
    lazy var FastFoodLabel : ImageAndLabel = {
        let View = ImageAndLabel()
        View.Label.textColor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
        View.IconImage.tintColor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1)
        View.backgroundColor = .clear
        View.IconImage.setImage(UIImage(named: "VOQ7Ws"), for: .normal)
    ...
    lazy var StackLabel : UIStackView = {
        let Stack = UIStackView(arrangedSubviews: [LocationLabel,FastFoodLabel,DateLabel])
