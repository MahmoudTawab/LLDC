...
@IBDesignable public class GMStepper: UIControl {
    ...
    @objc @IBInspectable public var value: Double = 0 {
        didSet {
            ...
            label.text = "lang".localizable == "ar" ? formattedValue?.NumAR() : formattedValue
            if oldValue != value {
    ...
    @objc @IBInspectable public var maximumValue: Double = 4 {
        didSet {
            value = min(maximumValue, max(minimumValue, value))
        }
    }
    ...
    */
    let labelSlideLength: CGFloat = 10
    ...
    */
    ...
    public override func layoutSubviews() {
        ...
        label.frame = CGRect(x: buttonWidth + 10, y: 0, width: labelWidth - 20, height: bounds.size.height)
