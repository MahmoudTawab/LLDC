...
open class GrowingTextView: UITextView {
    ...
    open override var intrinsicContentSize: CGSize {
        return CGSize(width: UIView.noIntrinsicMetric, height: ControlWidth(30))
    }
...
//            scrollToCorrectPosition()
    ...
    override open func draw(_ rect: CGRect) {
        ...
        if text.isEmpty {
            let placeholderRect = CGRect(x: ControlX(5), y: (minHeight / 2) - ControlHeight(13), width: rect.width , height: ControlWidth(30))
            ...
            if let attributedPlaceholder = attributedPlaceholder {
                ...
                paragraphStyle.alignment = "lang".localizable == "ar" ? .right : .left 
