...
open class FPNCountryListViewController: UITableViewController, UISearchResultsUpdating, UISearchControllerDelegate {
    ...
    open override func viewWillAppear(_ animated: Bool) {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [.foregroundColor : UIColor.black ,.font: UIFont(name: "SourceSansPro-BoldItalic", size: ControlWidth(15)) ?? UIFont.systemFont(ofSize: ControlWidth(15))]
